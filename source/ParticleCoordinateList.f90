module ParticleCoordinateListModule
...
! type: 
!--------------------------------------
  type,public :: ParticleCoordinateListType
    ! private data
    type(ParticleCoordinateType),allocatable,dimension(:) :: Items
    integer,private :: Count = 0
    integer,private :: CurrentBufferSize = -1
    integer :: ExpansionIncrement = 500
    integer :: InitialBufferSize = 5000
  contains
...
!------------------------------------------
  ...
  implicit none
  class(ParticleCoordinateListType),target :: this
  type(ParticleCoordinateType),pointer,intent(inout) :: itemPointer
...
!------------------------------------------
  ...
  implicit none
  class(ParticleCoordinateListType) :: this
  type(ParticleCoordinateType),intent(in) :: item
  integer :: count
  ...
  this%Items(this%Count)%GlobalX = item%GlobalX
  this%Items(this%Count)%GlobalY = item%GlobalY
  this%Items(this%Count)%GlobalZ = item%GlobalZ
...
!------------------------------------------
  ...
  class(ParticleCoordinateListType) :: this
  integer,intent(in) :: index
  type(ParticleCoordinateType) :: item
...
!------------------------------------------
  ...
  implicit none
  class(ParticleCoordinateListType) :: this
  type(ParticleCoordinateType),allocatable,dimension(:) :: itemArray
  integer :: n
...
!------------------------------------------
  ...
  implicit none
  class(ParticleCoordinateListType) :: this
  type(ParticleCoordinateType),allocatable,dimension(:) :: temp
  integer :: n
  ...
  do n = 1, this%Count
    ...
    this%Items(n)%GlobalX = temp(n)%GlobalX
    this%Items(n)%GlobalY = temp(n)%GlobalY
    this%Items(n)%GlobalZ = temp(n)%GlobalZ 
  end do
...
end module ParticleCoordinateListModule