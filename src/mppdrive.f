...
C***** SUBROUTINE *****
     ...
     3ICB,HPREV,PERLEN,TIMX,NUMTS,IGZBUF,IBPZON,CDATA,IBRMAP)
C
C
...
C
      IF(IVIEW.EQ.1) THEN
      IF(IUNIT(6).GT.0) CALL PGHB(IMIN,IMAX,JMIN,JMAX,1,NLAY,
     1 XMN,XMX,YMN,YMX,ZXT,ZXB,NCOL,NROW,NLAY,IVIEW,IUNIT(6),NCLR,
     2 IUSUM,IPROJ,LAYER,IPER,NCOL,NROW,0)
      IF(IUNIT(5).GT.0) CALL PDRAIN(IMIN,IMAX,JMIN,JMAX,1,NLAY,
     1 XMN,XMX,YMN,YMX,ZXT,ZXB,NCOL,NROW,NLAY,IVIEW,IUNIT(5),NCLR,
     2 IUSUM,IPROJ,LAYER,IPER,NCOL,NROW,0)
      IF(IUNIT(4).GT.0) CALL PRIVER(IMIN,IMAX,JMIN,JMAX,1,NLAY,
     1 XMN,XMX,YMN,YMX,NCOL,NROW,NLAY,IUNIT(4),NCLR,IVIEW,
     2 IBUFF,IUSUM,IPER)
      IF(IUNIT(9).GT.0) CALL PSTRM(IMIN,IMAX,JMIN,JMAX,1,NLAY,
     1 XMN,XMX,YMN,YMX,NCOL,NROW,NLAY,IUNIT(9),NCLR,IVIEW,
     2 IBUFF,IUSUM,IPER)
      IF(IUNIT(2).GT.0) CALL PWELLS(IMIN,IMAX,JMIN,JMAX,1,NLAY,
     1 XMN,XMX,YMN,YMX,ZXT,ZXB,NCOL,NROW,NLAY,IVIEW,IUNIT(2),NCLR,
     2 IUSUM,IPROJ,LAYER,IPER,NCOL,NROW,0)
 
C-----ELSE IF PLOT IS A CROSS SECTION ALONG A COLUMN...
C
      ELSE IF(IVIEW.EQ.2) THEN
      IF(IUNIT(6).GT.0) CALL PGHB(IMIN,IMAX,JCOLGD,JCOLGD,KMIN,KMAX,
     1 XMN,XMX,YMN,YMX,ZXT,ZXB,NCOL,NROW,NLAY,IVIEW,IUNIT(6),NCLR,
     2 IUSUM,IPROJ,ISLICE,IPER,NROW,NLAY,IYDIR)
      IF(IUNIT(5).GT.0) CALL PDRAIN(IMIN,IMAX,JCOLGD,JCOLGD,KMIN,KMAX,
     1 XMN,XMX,YMN,YMX,ZXT,ZXB,NCOL,NROW,NLAY,IVIEW,IUNIT(5),NCLR,
     2 IUSUM,IPROJ,ISLICE,IPER,NROW,NLAY,IYDIR)
      IF(IUNIT(2).GT.0) CALL PWELLS(IMIN,IMAX,JCOLGD,JCOLGD,KMIN,KMAX,
     1 XMN,XMX,YMN,YMX,ZXT,ZXB,NCOL,NROW,NLAY,IVIEW,IUNIT(2),NCLR,
     2 IUSUM,IPROJ,ISLICE,IPER,NROW,NLAY,IYDIR)
...
C
      ELSE IF(IVIEW.EQ.3) THEN
      IF(IUNIT(6).GT.0) CALL PGHB(IROWGD,IROWGD,JMIN,JMAX,KMIN,KMAX,
     1 XMN,XMX,YMN,YMX,ZXT,ZXB,NCOL,NROW,NLAY,IVIEW,IUNIT(6),NCLR,
     2 IUSUM,IPROJ,ISLICE,IPER,NCOL,NLAY,IXDIR)
      IF(IUNIT(5).GT.0) CALL PDRAIN(IROWGD,IROWGD,JMIN,JMAX,KMIN,KMAX,
     1 XMN,XMX,YMN,YMX,ZXT,ZXB,NCOL,NROW,NLAY,IVIEW,IUNIT(5),NCLR,
     2 IUSUM,IPROJ,ISLICE,IPER,NCOL,NLAY,IXDIR)
      IF(IUNIT(2).GT.0) CALL PWELLS(IROWGD,IROWGD,JMIN,JMAX,KMIN,KMAX,
     1 XMN,XMX,YMN,YMX,ZXT,ZXB,NCOL,NROW,NLAY,IVIEW,IUNIT(2),NCLR,
     2 IUSUM,IPROJ,ISLICE,IPER,NCOL,NLAY,IXDIR)
...
C--- PLOT MISCELLANEOUS LINES AND POINTS IF APPROPRIATE
C
      IF(IVIEW.EQ.1.AND.IMISC.EQ.1) CALL DCFDRW(3,IUDCF,NPCI,1,2,
     1   LVSACT,MAXLVS,IUSUM)
