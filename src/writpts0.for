...
C***** SUBROUTINE *****
      SUBROUTINE FILHDR_0(IU,VER,ICMPCT,TREF)
      CHARACTER*(*) VER
      CHARACTER*10 STYLE
      CHARACTER*4 LEFT
      CHARACTER*2 RIGHT
...
C***** SUBROUTINE *****
      SUBROUTINE WRITEP_0(IU,ICMPCT,IZONE,J,I,K,X,Y,ZL,Z,TOT,XSTRT,
...
C***** SUBROUTINE *****
      SUBROUTINE WRITTS_0(IU,ICMPCT,MPSTP,NP,J,I,K,X,Y,Z,ZL,T,NSTEP,
     1                  NROW,NCOL)
C
      IF(ICMPCT.EQ.1) THEN
        ND= (K-1)*NROW*NCOL + (I-1)*NCOL + J
...
C***** SUBROUTINE *****
      SUBROUTINE WRITPL_0(IU,ICMPCT,IP,X,Y,ZL,Z,T,J,I,K,NSTEP,NROW,NCOL)
c
      IF(ICMPCT.EQ.1) THEN
        ND= (K-1)*NROW*NCOL + (I-1)*NCOL + J
