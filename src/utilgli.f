...
C Changes:
C   This module (UTILGLI.F) is a slightly modified version of UTILGKS.F.
C   One change was made, specific to the GLI implementation of GKS, to
C   insert a call to the GKS subroutine GUWK as the first executable
C   statement in subroutine CLGKS.
