...
C Changes:
C   Use unit 91 for name file, unit 99 for GKS log file mplot.log.
...
C***********************************************************************
      INTEGER LCIBOU,LCXMX,LCXMN,LCDX,LCYMX,LCYMN,LCDY,LCZBOT,LCZTOP,
     ...
     4LCTIMX,LCNTS,LCIGZB,LCCDAT,LCIBRM,LENA,LCHPRV
      ...
      CHARACTER*80 RSPFIL,VER,FHELP,FSHELP,CFGFIL,CFGPTH,PRGNAM
...
C    version info for UNIX what command
      VER= '@(#)MODPATH-PLOT - A particle tracking postprocessing model'
     $     //' for MODFLOW'
      VER = 
     $  '@(#)MODPATH-PLOT - USGS Open-File Report 94-464, D.W. Pollock'
      VER = '@(#)MODPATH-PLOT - Contact: h2osoft@usgs.gov'
      VER = '@(#)MODPATH-PLOT - Version 3.00 (V3, Release 1, 9-94)'
      VER = '@(#)MODPATH-PLOT - Version 3.2, 2000/06/14'

C    SET VERSION NUMBER
      VER='MODPATH-PLOT Version 3.00 (V3, Release 2, 6-2000)'
      PRGNAM=VER
C
...
C  ELEMENT 7: PLOT TITLE & SCALE BAR COLOR
      ICO(7)=1
C  ELEMENT 8: WELL COLOR
      ICO(8)=2
C  ELEMENT 9: DRAIN COLOR
      ICO(9)=2
C  ELEMENT 10: GHB COLOR
      ICO(10)=2
C  ELEMENT 11: RIVER COLOR
      ICO(11)=4
...
C
      CALL FILES (IUMAIN,IBATCH,IUNIT,CUNIT,NUNIT,IUNAR,NIUNAR,VER)
C
