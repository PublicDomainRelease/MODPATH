...
C***** SUBROUTINE *****
      SUBROUTINE SPACE(NCOL,NROW,NLAY,NCBL,IGRID,NZDIM,
...
C
      ...
      ISUM=ISUM + NRNC
      ISM1=ISUM-1
      WRITE (IUSUM,5015) ISM1
5015  FORMAT(1X,I8,' ELEMENTS USED IN MASTER ARRAY.')
      RETURN
      END
...
C  OPEN GRAPHICS DEVICE DATA FILE
      ...
      ELSE
      CALL PUTSCR('UNABLE TO LOCATE AND OPEN FILE <device.dat>. STOP.')
      CALL ABORT
      END IF
C
