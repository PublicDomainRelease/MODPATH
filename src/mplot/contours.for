...
C
      CALL YESNOZ('LABEL CONTOURS ?',KLABEL,'6.1.12')
...
1000  FORMAT(1X,'VALUES ARE CONSTANT THROUGHOUT LAYER ',I2)
      ...
      IF(ISILNT.NE.1) THEN
      CALL PUTSCR(' ')
      WRITE(CHMIN,'(G12.5)') HMIN
      WRITE(CHMAX,'(G12.5)') HMAX
      CALL PUTSCR('THE MINIMUM & MAXIMUM VALUES FOR CONTOURING ARE:'//
     1      CHMIN//' '//CHMAX)
      CALL PUTSCR(' ')
      END IF
