...
C Changes:
C   Modified U1DREL, U2DINT, U2DREL to use unit 91 instead of unit 99
C   for reading arrays using the OPEN/CLOSE option to avoid conflict 
C   with unit 99 used for opening GKS log file MPLOT.LOG.
